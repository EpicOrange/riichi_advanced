...
The win condition is to score at least 8 fan with a hand of one of the following shapes:
...
- Honors and Knitted hand: 14 unique tiles from the following set: 147 of one suit, 258 of a second suit, 369 of a third suit, all winds, and all dragons.

You can win by self-draw, by discard, or by the tile of an added kong. If multiple players declare a win on the same discard or added kong tile, then the closest player in turn order to the discarder/kong player wins.
...
Swap-calling is allowed. If you call a 3 of bamboo, you may subsequently discard a 3 of bamboo in hand.

## Fan table

To win, one must have a hand worth at least 8 fan (additive). Note that a hand worth exactly 0 fan scores 8 fan (Chicken Hand #43).

Each of the 81 fan in MCR has a numeric ID, and they are typically categorized by their value. Here we start with the smallest value (minor fan) and work up to the largest.

Within each category, the fan are sorted by their frequency, which is provided courtesy of [MahjongSoft's data](https://mahjongsoft.com/mcrfans.php).

## 1 fan

#69-#73 are all repeatable: if you have two Pure Double Chows, you get 2 fan.
...
- __Short Straight (#71)__ (12.18%): You have 123 456 or 456 789 of one suit.
...
- __Quadruple Chow (#14)__ (0.00000%): You have four of the same sequence in the same suit.
...
- __Pure Terminal Chows (#13)__ (0.002295%): You have 123 123 55 789 789 in the same suit.
...
- __Seven Shifted Pairs (#6)__ (0.0002596%): You have 11 22 33 44 55 66 77 in one suit.
- __Nine Gates (#4)__ (0.0000000%): Your hand is concealed and is all one suit in the nine gates shape (1112345678999 + one extra tile).
...
In event of a discard, the discarder pays the payout. In event of a self-drawn win, every player pays the payout. Afterwards, everyone pays the winner 8 bonus points. So the minimum 8 fan self-drawn win results in the winner gaining 48 points total.
...
Another very practical strategy is Outside Hand. Even though it only gives you 4 points, the rest of the points come with it pretty easily. If you think about it, there is absolutely no way to have Outside Hand and not to have at least 6 points (with 2 points coming from some kind of double chows, terminal chows, terminal pungs etc), so you only need to take care of 2 more points. If you go for Outside Hand, start discarding single honours. It is much easier to get 2 additional points when your Outside Hand does not have honours in it.
...
Otherwise you will have to combine as many minor fan as you can, notably you can at least force the following:
...
There is also the option to go for (8 fan) __Chicken Hand (#43)__ (0.8192%), which boils down to the following requirements:
...
- (1 fan) __Short Straight (#71)__ (12.18%): You have 123 456 or 456 789 of one suit.
