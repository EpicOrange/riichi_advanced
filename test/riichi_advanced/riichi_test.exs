defmodule RiichiAdvanced.RiichiTest do
  ...
  alias RiichiAdvanced.GameState.TileOrdering, as: TileOrdering
  ...
  test "standard hand win" do
    ...
    assert Match.match_hand(hand, [], @riichi_win_definition, %TileBehavior{ ordering: %TileOrdering{ ordering: @ordering, ordering_r: @ordering_r } })
  end

  test "tenpai is not win" do
    hand = [:"2m", :"3m", :"4m", :"4m", :"5m", :"6m", :"7p", :"7p", :"7p", :"8s", :"8s", :"8s", :"6p", :"7p"]
    assert not Match.match_hand(hand, [], @riichi_win_definition, %TileBehavior{ ordering: %TileOrdering{ ordering: @ordering, ordering_r: @ordering_r } })
  end
