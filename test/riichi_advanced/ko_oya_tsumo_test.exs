defmodule RiichiAdvanced.KoOyaTsumoTest do
  ...
  def tsumo_loss_yakuman_test(tsumo_loss, seat, expected_score, expected_delta_scores) do
    mods = ["yaku/ippatsu", "nagashi", "tobi", "suufon_renda", "suucha_riichi", "suukaikan", "agarirenchan", "tenpairenchan", "kyuushu_kyuuhai", "double_wind_4_fu", "yaku/renhou_yakuman", "pao", "show_waits", "kansai_draw", "kansai_flowers", "kansai_yaku", "nagashi_yakuman", "kansai_no_furiten_riichi", "kansai_30_fu", "dora", %{name: "aka", config: %{"man" => 1, "pin" => 1, "sou" => 1}}, "ura", "kandora"]
