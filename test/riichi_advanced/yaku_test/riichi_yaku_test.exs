defmodule RiichiAdvanced.YakuTest.RiichiYaku do
  ...
  test "riichi - dragons triple ron" do
    ...
    """, [
      ...
      south: %{
        yaku: [{"Honitsu", [2, "Han"]}, {"Ittsu", [1, "Han"]}, {"Haku", [1, "Han"]}]
      },
      west: %{
        yaku: [{"Honitsu", [2, "Han"]}, {"Ittsu", [1, "Han"]}, {"Hatsu", [1, "Han"]}]
      },
      north: %{
        yaku: [{"Honitsu", [2, "Han"]}, {"Ittsu", [1, "Han"]}, {"Chun", [1, "Han"]}]
      }
    })
  end
  ...
  test "riichi - open chuurenpoutou" do
    ...
    """, [
      ...
      east: %{
        yaku: [{"Chinitsu", [5, "Han"]}, {"Ittsu", [1, "Han"]}],
        minipoints: 30
      }
    })
  end
