defmodule RiichiAdvanced.YakuTest.RiichiYaku do
  ...
  test "riichi - double riichi ippatsu tsumo" do
    ...
    """, [
      ...
      east: %{
        yaku: [{"Double Riichi", [2, "Han"]}, {"Ippatsu", [1, "Han"]}, {"Tsumo", [1, "Han"]}, {"Tanyao", [1, "Han"]}],
        minipoints: 40
      }
    })
  end
  ...
  test "riichi - ippatsu shouldn't be awarded if riichi tile gets called" do
    ...
    """, [
      ...
      east: %{
        yaku: [{"Double Riichi", [2, "Han"]}, {"Tsumo", [1, "Han"]}, {"Tanyao", [1, "Han"]}],
        minipoints: 40
      }
    })
  end
  ...
  test "riichi - open tanyao sanshoku" do
    ...
    """, [
      ...
      east: %{
        yaku: [{"Tanyao", [1, "Han"]}, {"Sanshoku", [1, "Han"]}],
        minipoints: 30
      }
    })
  end
  ...
  test "riichi - non-pinfu closed tsumo sanshoku" do
    ...
    """, [
      ...
      east: %{
        yaku: [{"Tsumo", [1, "Han"]}, {"Sanshoku", [2, "Han"]}],
        minipoints: 30
      }
    })
  end
  ...
  test "riichi - pinfu tsumo" do
    ...
    """, [
      ...
      east: %{
        yaku: [{"Tsumo", [1, "Han"]}, {"Pinfu", [1, "Han"]}, {"Sanshoku", [2, "Han"]}],
        minipoints: 20
      }
    })
  end
  ...
  test "riichi - pinfu chankan" do
    ...
    """, [
      ...
      south: %{
        yaku: [{"Chankan", [1, "Han"]}, {"Pinfu", [1, "Han"]}],
        minipoints: 30
      }
    })
  end
  ...
  test "riichi - closed iipeikou chun" do
    ...
    """, [
      ...
      east: %{
        yaku: [{"Iipeikou", [1, "Han"]}, {"Chun", [1, "Han"]}],
        minipoints: 40
      }
    })
  end
  ...
  test "riichi - daisharin" do
    ...
    """, [
      ...
      east: %{
        yaku: [{"Pinfu", [1, "Han"]}, {"Tanyao", [1, "Han"]}, {"Ryanpeikou", [3, "Han"]}, {"Chinitsu", [6, "Han"]}],
        minipoints: 30
      }
    })
  end
  ...
  test "riichi - open chanta sanshoku" do
    ...
    """, [
      ...
      east: %{
        yaku: [{"Chanta", [1, "Han"]}, {"Sanshoku", [1, "Han"]}],
        minipoints: 30
      }
    })
  end
  ...
  test "riichi - sankantsu" do
    ...
    """, [
      ...
      east: %{
        yaku: [{"Chun", [1, "Han"]}, {"Sankantsu", [2, "Han"]}],
        minipoints: 70
      }
    })
  end
  ...
  test "riichi - open toitoi shousangen honitsu" do
    ...
    """, [
      ...
      east: %{
        yaku: [{"Haku", [1, "Han"]}, {"Chun", [1, "Han"]}, {"Toitoi", [2, "Han"]}, {"Shousangen", [2, "Han"]}],
        minipoints: 60
      }
    })
  end
  ...
  test "riichi - closed honitsu honroutou" do
    ...
    """, [
      ...
      east: %{
        yaku: [{"Haku", [1, "Han"]}, {"Toitoi", [2, "Han"]}, {"Sanankou", [2, "Han"]}, {"Honroutou", [2, "Han"]}, {"Honitsu", [3, "Han"]}],
        minipoints: 60
      }
    })
  end
  ...
  test "riichi - sanankou open one pon" do
    ...
    """, [
      ...
      east: %{
        yaku: [{"Toitoi", [2, "Han"]}, {"Sanankou", [2, "Han"]}],
        minipoints: 50
      }
    })
  end
  ...
  test "riichi - sanankou after completing sequence" do
    ...
    """, [
      ...
      east: %{
        yaku: [{"Tsumo", [1, "Han"]}, {"Sanankou", [2, "Han"]}],
        minipoints: 60
      }
    })
  end
  ...
  test "riichi - daisangen tsuuiisou suuankou" do
    ...
    """, [
      ...
      east: %{
        yaku: [{"Daisangen", [1, "★"]}, {"Suuankou", [1, "★"]}, {"Tsuuiisou", [1, "★"]}]
      }
    })
  end
  ...
  test "riichi - chuurenpoutou with tenhou (upgrades into junsei)" do
    ...
    """, [
      ...
      east: %{
        yaku: [{"Tenhou", [1, "★"]}, {"Junsei Chuurenpoutou", [2, "★"]}]
      }
    })
  end
  ...
  test "riichi - chuurenpoutou with chiihou (no upgrade)" do
    ...
    """, [
      ...
      south: %{
        yaku: [{"Chiihou", [1, "★"]}, {"Chuurenpoutou", [1, "★"]}]
      }
    })
  end
  ...
  test "riichi - juusan kokushi" do
    ...
    """, [
      ...
      south: %{
        yaku: [{"Kokushi Musou Juusan Menmachi", [2, "★"]}]
      }
    })
  end
  ...
  test "riichi - kokushi with chiihou (no upgrade)" do
    ...
    """, [
      ...
      south: %{
        yaku: [{"Chiihou", [1, "★"]}, {"Kokushi Musou", [1, "★"]}]
      }
    })
  end
  ...
  test "riichi - shousuushii tsuuiisou" do
    ...
    """, [
      ...
      east: %{
        yaku: [{"Tsuuiisou", [1, "★"]}, {"Shousuushii", [1, "★"]}]
      }
    })
  end
  ...
  test "riichi - dragons triple ron" do
    ...
    """, [
      ...
      south: %{
        yaku: [{"Honitsu", [2, "Han"]}, {"Ittsuu", [1, "Han"]}, {"Haku", [1, "Han"]}]
      },
      west: %{
        yaku: [{"Honitsu", [2, "Han"]}, {"Ittsuu", [1, "Han"]}, {"Hatsu", [1, "Han"]}]
      },
      north: %{
        yaku: [{"Honitsu", [2, "Han"]}, {"Ittsuu", [1, "Han"]}, {"Chun", [1, "Han"]}]
      }
    })
  end
  ...
  test "riichi - open chuurenpoutou" do
    ...
    """, [
      ...
      east: %{
        yaku: [{"Chinitsu", [5, "Han"]}, {"Ittsuu", [1, "Han"]}],
        minipoints: 30
      }
    })
  end
