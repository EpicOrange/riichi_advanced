defmodule RiichiAdvanced.YakuTest.FuzhouYaku do
  ...
  test "fuzhou - only one flower" do
    ...
    """, [
      ...
      east: %{
        yaku: [@base, {"Flowers", [2, ""]}, {"Only One Flower", [15, ""]}]
      }
    })
  end
  ...
  test "fuzhou - flower jin as flower scores both gold and flower" do
    ...
    """, [
      ...
      east: %{
        yaku: [@base, {"Flowers", [2, ""]}, {"Gold", [2, ""]}, {"Only One Flower", [15, ""]}]
      }
    })
  end
  ...
  test "fuzhou - dealer continuation" do
    ...
    """, [
      ...
      east: %{
        yaku: [@base, {"Dealer Continuation", [2, ""]}]
      }
    })
  end
  ...
  test "fuzhou - open and closed kong" do
    ...
    """, [
      ...
      east: %{
        yaku: [@base, {"Concealed Kongs", [2, ""]}, {"Open Kongs", [2, ""]}]
      }
    })
  end
  ...
  test "fuzhou - full bloom with flowers" do
    ...
    """, [
      ...
      east: %{
        yaku: [@base, {"Flowers", [8, ""]}, {"Full Bloom (Flowers)", [12, ""]}]
      }
    })
  end
  ...
  test "fuzhou - full bloom with honors" do
    ...
    """, [
      ...
      east: %{
        yaku: [@base, {"Flowers", [8, ""]}, {"Full Bloom (East)", [12, ""]}]
      }
    })
  end
  ...
  test "fuzhou - golden dragon" do
    ...
    """, [
      ...
      east: [
        %{yaku: [@base, {"Golden Dragon", [40, ""]}]},
        %{yaku: [{"All Sequences", [10, ""]}, @base, {"Three Gold Knockdown", [30, ""]}]},
      ]
    })
  end
  ...
  test "fuzhou - golden dragon shanpon tsumo" do
    # waits on 3m or 8m@jin
    # if 3m, then the two existing jin in hand become 4m and 5m, creating all sequences
    # if 8m, then it's a golden dragon OR it can do the above, but adding three gold knockdown
    TestUtils.test_yaku_advanced("fuzhou", [], """
    {
      "starting_hand": {
        "east": ["3m", "3m", "5m", "5m", "6m", "7m", "8m", "2s", "3s", "4s", "4p", "5p", "6p", "7p", "8p", "9p"],
        "south": ["2m", "4m", "7m", "2p", "3p", "4p", "6p", "7p", "8p", "9p", "2s", "4s", "5s", "6s", "7s", "8s"],
        "west": ["2m", "4m", "7m", "2p", "3p", "4p", "6p", "7p", "8p", "9p", "2s", "4s", "5s", "6s", "7s", "8s"],
        "north": ["2m", "4m", "7m", "2p", "3p", "4p", "6p", "7p", "8p", "9p", "2s", "4s", "5s", "6s", "7s", "8s"]
      },
      "starting_draws": ["8m", "5s", "3s", "1s", "8m"],
      "starting_dead_wall": ["8m"]
    }
    """, [
      %{"type" => "buttons_pressed", "buttons" => [%{"button" => "start_no_flower"}, nil, nil, nil]},
      ...
      east: [
        %{yaku: [@base, {"Golden Dragon", [40, ""]}]},
        %{yaku: [@base, {"All Sequences", [10, ""]}, {"Three Gold Knockdown", [30, ""]}]},
      ]
    })
  end
  ...
  test "fuzhou - blessing of heaven" do
    ...
    """, [
      ...
      east: %{
        yaku: [@base, {"Blessing of Heaven", [50, ""]}]
      }
    })
  end
  ...
  test "fuzhou - blessing of earth" do
    ...
    """, [
      ...
      south: %{
        yaku: [@base, {"Blessing of Earth", [40, ""]}]
      }
    })
  end
