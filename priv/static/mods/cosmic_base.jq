...
.available_mods = [
  ...
  {"id": "kontsu", order: 1, "name": "Kontsu", "desc": "Add mixed triplets, or kontsu. If you have the same number in three suits, that counts as one of your sets towards four sets and a pair. For example, 1m1s1p is a kontsu. Also considered kontsu: 3 different winds, or one of each dragon."},
  {"id": "cosmic_calls", order: 1, "deps": ["kontsu"], "name": "Cosmic Calls", "desc": "Add the following calls: Ton (calls a pair), Chon (calls kontsu), and Fuun (calls a set of 4 different winds). The precedence is Ton < Chii < Chon < Fuun < Pon < Kan."},
  ...
  {"id": "yakuman_13_han", "order": 2, "name": "Yakuman 13 Han", "desc": "This is a utility mod for Cosmic Riichi that changes all yakuman to be 13 han. You may disable it if you don't want yakuman to stack with normal yaku."}
] + .available_mods
