.after_initialization.actions += [
  ...
  ["add_rule", "1 Han", "Sekinin Barai (Pao)", "(Suurenkou) If you win with suurenkou (111 222 333 444 of the same suit) and called the fourth triplet or kan from a player, that player is responsible for the yakuman payment if you tsumo, or half of the payment if you ron off someone else."]
]
|
.yakuman += [
  {
