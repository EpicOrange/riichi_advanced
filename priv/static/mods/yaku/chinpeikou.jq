.after_initialization.actions += [["add_rule", "3 Han", "Chinpeikou", "3 han on top of ryanpeikou if your ryanpeikou sequences are all the same numbers (may be different suits), like 112233m 112233p. No restriction on the pair, so you can have an honor pair (despite 'chin' being in the name).", 103]]
|
