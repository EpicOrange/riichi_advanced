.after_initialization.actions += [["add_rule", "1 Han", "Ketsupaihou", "\"Missing Tile\". Win with an edge or middle wait on a tile for which three copies are already publicly visible.", 101]]
|
