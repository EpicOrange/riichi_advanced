.after_initialization.actions += [
  ...
  ["update_rule", "Yakuman", "Suuchoupaikou", "%{example_hand}", {"example_hand": ["2m", "2m", "2m", "4m", "4m", "4m", "6m", "6m", "6m", "8m", "8m", "8m", "3s", "3x", "3s"]}],
  ["add_rule", "Rules", "Sekinin Barai (Pao)", "(Suuchoupaikou) If you win with suuchoupaikou (111 333 555 777 of the same suit) and called the fourth triplet or kan from a player, that player is responsible for the yakuman payment if you tsumo, or half of the payment if you ron off someone else."]
]
|
.yakuman += [
  {
