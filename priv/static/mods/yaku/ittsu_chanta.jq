.after_initialization.actions += [
  ["add_rule", "2 Han", "Ittsu Chanta", "Ittsu becomes 2 han if the rest of your hand is chanta (or junchan, in which case it's 3 han). +1 han if closed.", 102],
  ["update_rule", "2 Han", "Ittsu Chanta", "%{example_hand}", {"example_hand": ["1m", "2m", "3m", "4m", "5m", "6m", "7m", "8m", "9m", "1s", "2s", "3s", "2z", "3x", "2z"]}]
]
|
...
|
.meta_yaku += [
  { "display_name": "Ittsu Chanta", "value": [1, "Han"], "when": [{"name": "has_no_call_named", "opts": $open_calls}, {"name": "has_existing_yaku", "opts": ["Ittsu Chanta"]}] },
  { "display_name": "Ittsu Junchan", "value": [1, "Han"], "when": [{"name": "has_no_call_named", "opts": $open_calls}, {"name": "has_existing_yaku", "opts": ["Ittsu Junchan"]}] }
]
|
.yaku_precedence += {
  "Ittsu Chanta": ["Ittsu"],
