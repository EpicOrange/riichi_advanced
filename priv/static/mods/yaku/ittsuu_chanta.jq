.after_initialization.actions += [
  ["add_rule", "2 Han", "Ittsuu Chanta", "Ittsuu becomes 2 han if the rest of your hand is chanta (or junchan, in which case it's 3 han). +1 han if closed.", 102],
  ["update_rule", "2 Han", "Ittsuu Chanta", "%{example_hand}", {"example_hand": ["1m", "2m", "3m", "4m", "5m", "6m", "7m", "8m", "9m", "1s", "2s", "3s", "2z", "3x", "2z"]}]
]
|
...
|
.yaku_precedence += {
  "Ittsuu Chanta": ["Ittsuu"],
  "Ittsuu Junchan": ["Ittsuu Chanta"]
}
