.after_initialization.actions += [["add_rule", "Local Yaku (Yakuman)", "(Kachoufuugetsu) \"Flower, Bird, Wind, Moon\". Your hand is 555p (5 circles) + 111s (birds) + triplet of round or seat wind + 111p (1 circles).", 113]]
|
