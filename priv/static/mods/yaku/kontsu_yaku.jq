...
|
.yaku += [
  { "display_name": "Mini-Sangen", "value": "mini_sangen", "when": [{"name": "counter_at_least", "opts": ["mini_sangen", 0.5]}] },
  { "display_name": "Mixed Winds", "value": "mixed_winds", "when": [{"name": "counter_at_least", "opts": ["mixed_winds", 0.5]}] },
