.after_initialization.actions += [
  ...
  ["add_rule", "3+ Han", "Chintanfon", "\"Purely Without Red\". 5 han if your hand contains no red or honor tiles. This means you can have only 248p (2,4,8 circles) and 23468s (2,3,4,6,8 bamboo). 6 han if closed.", 105],
  ["update_rule", "3+ Han", "Chintanfon", "%{example_hand}", {"example_hand": ["2p", "2p", "2p", "4p", "4p", "4p", "2s", "3s", "4s", "6s", "8s", "8s", "8s", "3x", "6s"]}]
]
|
...
.yaku += [
  {
    ...
    "value": [2, "Han"],
    "when": [{"name": "winning_hand_consists_of", "opts": ["2p","4p","8p","2s","3s","4s","6s","8s","1z","2z","3z","4z","5z","6z"]}]
  },
  {
    "display_name": "Chintanfon",
    "value": [5, "Han"],
    "when": [{"name": "winning_hand_consists_of", "opts": ["2p","4p","8p","2s","3s","4s","6s","8s"]}]
  }
]
|
.meta_yaku += [
