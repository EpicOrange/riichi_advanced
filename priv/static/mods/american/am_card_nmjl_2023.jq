.win_definition = [
    # 2023
    "222a 0000 222b 3333b",
    "FF 2023a 2222b 3333c",
    "FFFF DDDa 2023a|2023b|2023c DDDb|DDDc",
    "22a 000 NEWS 222b 33b", # concealed
    # 2468
    "FFFF 2222a 46a 8888a",
    ...
    "22a 4444a 44b 6666b 88c",
    "222a 888a DDDDb DDDDc",
    "FF 222a 44a 66a 888a DDa", # concealed
    # Any Like Numbers
    "FFFF XXXX0a XX0b XXXX0c",
    "FF XXX0a Da XXX0b Db XXX0c Dc", # concealed
    # Addition Hands
    "FF 1111a 1111b 2222c",
    "FF 2222a 2222b 4444c",
    "FF 3333a 3333b 6666c",
    "FF 4444a 4444b 8888c",
    # Quints
    ...
    "X0a XX1a XXX2a XXXX3b XXXX4c",
    "FF XXXX0a XXXX1a XXXX2a", "FF XXXX0a XXXX1b XXXX2c",
    "XXX0a XXXX1a XXX0b XXXX1b",
    "FFFF XX0a XX1a XXX2b XXX2c",
    "FF XXX0a XX1a XX2a XXX3a DDa", #concealed
    # 13579
    ...
    "FF 1111a 33a 5555a DDa", "FF 5555a 77a 9999a DDa",
    "11a 333a DDDDc 333b 55b", "55a 777a DDDDc 777b 99b",
    "FFFF 11a 33a 555b 555c", "FFFF 55a 77a 999b 999c",
    "1111a 33b 55b 77b 9999a",
    "111a 3a 555a 555b 7b 999b", #concealed
    # Winds and Dragons
    "NNNN EEE WWW SSSS", "NNN EEEE WWWW SSS",
    "NNN SSS XX0a XX1a XXXX2a", "EEE WWW XX0a XX1a XXXX2a",
    "NNNN SSSS DDDa DDDb", "EEEE WWWW DDDa DDDb",
    "FF NNNN 2023a SSSS", "FF EEEE 2023a WWWW",
    "FFFF N EE WWW SSSS",
    "DDDDa NN E W SS DDDDb",
    "NNN E W SSS XXX0a XXX1b", #concealed
    # 369
    "333a 6666a 666b 9999b"
    "FFFF 3333a 66a 9999a", "FFFF 3333a 66b 9999c",
    "33a 66a 333b 666b 9999c",
    "FF 33a 66a 99a DDDb DDDc",
    "3a 66a 999a 3333b 3333c", "3a 66a 999a 6666b 6666c", "3a 66a 999a 9999b 9999c",
    ...
    "33a 66a 99a Da 33b 66b 99b Db", # concealed
    "FF 2a 4a 66a 88a 2b 4b 66b 88b", # concealed
    "XX0a XX1a XX2a XX3a XX4a XX5a XX6a", # concealed
    "FF 2023a 2023b 2023c" # concealed
  ]
|

### <TODO: Edit everything below this line.>
...
.yaku = [
    ...
    { "display_name": "Consecutive Run #4", "value": 25, "when": [{"name": "match", "opts": [["hand", "call_tiles", "winning_tile"], ["FFF X0aX1aX2a XXXX3b XXXX4c"]]}] },
    ...
    { "display_name": "Consecutive Run #7", "value": 30, "when": [{"name": "match", "opts": [["hand", "call_tiles", "winning_tile"], ["XX0aX1aX2aX3aX4a XXXX0b XXXX0c", "X0aXX1aX2aX3aX4a XXXX1b XXXX1c", "X0aX1aXX2aX3aX4a XXXX2b XXXX2c", "X0aX1aX2aXX3aX4a XXXX3b XXXX3c", "X0aX1aX2aX3aXX4a XXXX4b XXXX4c"]]}] },
    ...
    { "display_name": "Winds and Dragons #2", "value": 25, "when": [{"name": "match", "opts": [["hand", "call_tiles", "winning_tile"], ["FF X0X1X2a DDb DDDc DDDDa"]]}] },
