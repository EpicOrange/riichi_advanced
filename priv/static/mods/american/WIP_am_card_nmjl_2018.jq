...
.yaku = [
      ...
      ## PROGRESS -----------------------------------------------------------------------------------------------------------------------------------------------------------
    { "display_name": "2018 #1", "value": 25, "when": [{"name": "match", "opts": [["hand", "call_tiles", "winning_tile"], ["FF 2018a 2222b 2222c"]]}] },
    { "display_name": "2018 #2", "value": 25, "when": [{"name": "match", "opts": [["hand", "call_tiles", "winning_tile"], ["FF RRRR 2018a GGGG"]]}] },
    { "display_name": "2018 #3", "value": 25, "when": [{"name": "match", "opts": [["hand", "call_tiles", "winning_tile"], ["FFFFF 22a 222b 2018c"]]}] },
    { "display_name": "2018 #4", "value": 30, "when": [{"name": "has_no_call_named", "opts": ["am_pung", "am_kong", "am_quint"]}, {"name": "match", "opts": [["hand", "call_tiles", "winning_tile"], ["NN EEE 2018a WWW SS"]]}] },
    ...
    { "display_name": "Winds and Dragons #6", "value": 25, "when": [{"name": "match", "opts": [["hand", "call_tiles", "winning_tile"], ["FF NNNN 2018a SSSS", "FF EEEE 2018a WWWW"]]}] },
    ...
    { "display_name": "Singles and Pairs #7", "value": 85, "when": [{"name": "has_no_call_named", "opts": ["am_pung", "am_kong", "am_quint"]}, {"name": "match", "opts": [["hand", "call_tiles", "winning_tile"], ["FF 2018a NEWS 2018b"]]} ] }
  ]
