.after_initialization.actions += [["add_rule", "Rules", "Uma", "At the end of the game, 1st/2nd/3rd/4th receive a bonus of \($_1st * 1000)/\($_2nd * 1000)/\($_3rd * 1000)/\($_4th * 1000) points."]]
|
