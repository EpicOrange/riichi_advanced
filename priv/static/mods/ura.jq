...
.before_win.actions += [
  ["when", [{"name": "status", "opts": ["riichi"]}, {"name": "status_missing", "opts": ["ura_revealed"]}], [
    ...
    ["when", [{"name": "tile_not_revealed", "opts": [-6]}, {"name": "tile_not_revealed", "opts": [-16]}], [["reveal_tile", "1x"]]],
    ["when", [{"name": "tile_not_revealed", "opts": [-6]}, {"name": "tile_not_revealed", "opts": [-18]}], [["reveal_tile", "1x"]]],
    ...
    ["when", [{"name": "tile_not_revealed", "opts": [-6]}, {"name": "tile_not_revealed", "opts": [-15]}], [["reveal_tile", "1x"]]],
    ["when", [{"name": "tile_not_revealed", "opts": [-6]}, {"name": "tile_not_revealed", "opts": [-17]}], [["reveal_tile", "1x"]]]
  ]],
