...
|
.custom_style.tile_indices += {"789j": "789"}
|
...
.after_initialization.actions += [
  ["add_rule", "Tiles", "Jokers", "- One %{789j} joker is added to the wall. This joker acts as any tile numbered 7, 8, or 9.", {"789j": ["789j"]}, -99]
]