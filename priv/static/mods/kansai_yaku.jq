...
|
.yaku += [
  #{ "display_name": "Three Consecutive Triplets", "value": [2, "Han"], "when": [{"name": "match", "opts": [["hand", "calls", "winning_tile"], ["一色三連刻"]]}] },
  #{ "display_name": "Big Three Winds", "value": [2, "Han"], "when": [{"name": "match", "opts": [["hand", "calls", "winning_tile"], ["big_three_winds"]]}] }
]
|
.yakuman += [
...
|
.meta_yaku += [
  { "display_name": "Honitsu Chiitoitsu", "value": [6, "Han"], "when": [{"name": "has_existing_yaku", "opts": ["Honitsu", "Chiitoitsu"]}] }
]
|
.meta_yakuman += [
