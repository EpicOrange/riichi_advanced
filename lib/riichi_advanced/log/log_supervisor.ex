defmodule RiichiAdvanced.LogSupervisor do
  ...
  def init(opts) do
    ...
    children = [
      {RiichiAdvanced.GameSupervisor, name: {:via, Registry, {:game_registry, Utils.to_registry_name("game", ruleset, room_code)}}, supervisor: self(), room_code: room_code, ruleset: ruleset, mods: mods},
