defmodule RiichiAdvanced.GameState.Payment do
  ...
  def get_highest_scoring_txn(state_cxts, get_worst_instead \\ false)
  def get_highest_scoring_txn([], _get_worst_instead), do: nil
  def get_highest_scoring_txn([cxt], _get_worst_instead), do: cxt
  def get_highest_scoring_txn(state_cxts, get_worst_instead) do
