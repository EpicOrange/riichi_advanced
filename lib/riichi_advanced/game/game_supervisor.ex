defmodule RiichiAdvanced.GameSupervisor do
  ...
  def init(opts) do
    ...
    children = [
      ...
      {RiichiAdvanced.GameState, name: Utils.via_registry("game_state", ruleset, room_code), supervisor: supervisor, room_code: room_code, ruleset: ruleset, mods: mods, config: config, private: private, reserved_seats: reserved_seats}
    ]
