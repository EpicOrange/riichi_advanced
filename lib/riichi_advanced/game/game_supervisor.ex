defmodule RiichiAdvanced.GameSupervisor do
  ...
  def init(opts) do
    ...
    children = [
      ...
      {RiichiAdvanced.GameState, name: {:via, Registry, {:game_registry, Utils.to_registry_name("game_state", ruleset, room_code)}}, room_code: room_code, ruleset: ruleset, mods: mods, config: config}
    ]
