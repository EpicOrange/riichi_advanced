defmodule RiichiAdvanced.Validator do
  ...
  @allowed_actions [
    ...
    # minipoints actions
    "put_calls_in_hand", "put_winning_tile_in_hand", "remove_attrs", "add", "convert_calls", "remove_calls", "remove_winning_groups", "remove_groups", "retain_empty_hands", "round_up", "take_maximum", "add_original_hand", "print"
  ]
