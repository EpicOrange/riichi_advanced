defmodule RiichiAdvancedWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RiichiAdvancedWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RiichiAdvancedWeb.Gettext, "errors", msg, opts)
    end
  end
