defmodule RiichiAdvancedWeb.IndexLive do
  ...
  def mount(_params, session, socket) do
    ...
    socket = assign(socket, :rulesets, [
      ...
      {"kansai",       "Kansai Sanma (beta)", "Sanma, but you draw until the last visible dora indicator. In addition, all fives are akadora, fu is fixed at 30, there is no tsumo loss, and scores are rounded to the nearest 1000. Flowers act as nukidora in place of north winds, which are now yakuhai."},
